 ...
 class="section flex items-center bg-light-primary dark:bg-dark-primary lg:h-[85vh] overflow-hidden">
  <div class="container mx-auto h-full">
    <div class="flex flex-col md:flex-row items-center h-full pt-8">
        <div class="flex-1 flex flex-col items-center lg:items-center" >
           <p class=" text-lg text-accent text-md mb-[22px]">hey, i'm yessine ! 👋👋 </p>
           <h1
               class="
                      txt-4xl
                     leading-[44fpx]
           ...
           <div class="flex items-center mb-6">
            <a
              href="https://www.facebook.com/agmoun.yan/"
              
              class=" h-12 w-12 rounded-full flex items-center justify-center border border-white text-black hover:bg-light-secondary hover:border-light-secondary dark:hover:bg-dark-secondary dark:hover:border-dark-secondary mr-3 sm:mr-4 text-light-tail-500 dark:text-dark-navy-100  "
            >
              <svg
                width="8"
                height="16"
            ...
            <a
              href="https://twitter.com/daoudyassine12"
              class="h-12 w-12 rounded-full flex items-center justify-center border border-white text-black hover:bg-light-secondary hover:border-light-secondary dark:hover:bg-dark-secondary dark:hover:border-dark-secondary mr-3 sm:mr-4 text-light-tail-500 dark:text-dark-navy-100  "
            >
              <svg
                width="16"
            ...
            <a
              href="//www.youtube.com/channel/UCVH8KUZ5M2G6NmT0PeIIxeg"
              class="h-12 w-12 rounded-full flex items-center justify-center border border-white text-black hover:bg-light-secondary hover:border-light-secondary dark:hover:bg-dark-secondary dark:hover:border-dark-secondary mr-3 sm:mr-4 text-light-tail-500 dark:text-dark-navy-100 "
            >
              <svg
                width="16"
            ...
            <a
              href="https://www.linkedin.com/in/yassine-daoud-290203229/"
              class="h-12 w-12 rounded-full flex items-center justify-center border border-white text-black hover:bg-light-secondary hover:border-light-secondary dark:hover:bg-dark-secondary dark:hover:border-dark-secondary mr-3 sm:mr-4 text-light-tail-500 dark:text-dark-navy-100 "
            >
              <svg
                width="14"
      ...
      <div class=" flex flex-1 justify-end items-center h-full mt-8 md:mt-0">
        <img class="max-w-full lg:ml-auto" src="https://cdn.tailgrids.com/2.0/image/marketing/images/hero/hero-image-01.png" alt="hero"/>
      </div>
  </div>
</section>