<section id="contact" class="section bg-light-primary dark:bg-dark-primary">
    <div class="container mx-auto">
        ...
        <div class="flex flex-col lg:flex-row lg:gap-x-8">
            <div
               class="flex flex-1 flex-col
                ...
                <div>
                        ...
                        <p class="text-accent font-normal">Email me at daoudyassine007@gmail.com </p>
                ...
                <div>
                        ...
                        <p class=" text-paragraph mb-1">sfax,sakiet ezzit</p>
            ...
            <div  x-show="showMessage" 
               ...
               <div class="max-w-7xl mx-auto">Thank you for contact me .</div> 
             </div>
               @csrf
   ...
   <div class="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
       ...
       <div class="px-4 py-2 bg-white rounded-b-lg dark:bg-gray-800">
           ...
           <textarea name="body" x-model="form.body" id="editor" rows="8" class="block w-full px-0 text-sm text-gray-800 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400" placeholder="Write an article..."></textarea>
           <span x-show="errors.body" x-text="errors.body[0]" class="text-sm text-red-400 "></span>
        </div>
   </div>
   

                <button type="Submit" class="btn btn-lg bg-accent hover:bg-light-secondary dark:bg-dark-secondary text-black dark:text-white hover:text-light-tail-500 dark:hover:text-wdark-navy-100">Send Message</button>
            </form>

        </div>
        <div class=" flex flex-1 justify-end items-center h-full mt-8 md:mt-0">
        <img class="max-w-full lg:ml-auto" src="/img/contact.png" alt="contact"/>
      </div>
